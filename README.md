...
# Integrating the SDK
Step 1: Obtain AppId and apiKey

Register an account at https://console.dlink.cloud. After creating an app on the platform, obtain the corresponding AppId and apiKey for that app.
...
```java
 ApiContext CONTEXT = ApiContext.create("{appid}", "{apiKey}")
